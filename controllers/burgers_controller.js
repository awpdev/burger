...
router.get("/", (req, res) => {
    burger.selectAll(data => {
        // this for loop assigns the value in the devoured column to true or false. the true/false is then used as a condition in index.handlebars for if/unless statements
